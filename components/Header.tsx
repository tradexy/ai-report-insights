...
export const Header: React.FC<HeaderProps> = ({ onSettingsClick }) => {
  ...
  return (
    <header id="app-header" className="bg-gradient-to-r from-slate-800 to-slate-700 text-white p-6 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            onClick={handlePrint}
            className="flex items-center p-2.5 rounded-md hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-500 transition-colors duration-150"
            aria-label="Print Area Results / PDF"
            title="Opens print dialog. Choose 'Save as PDF' or select your printer."
          >
            ...
            <div className="hidden sm:flex sm:flex-col text-xs leading-tight text-left">
              <span>Print Area</span>
              <span>Results / PDF</span>
            </div>
          </button>
          <button
            id="settings-action-button"
            onClick={onSettingsClick}
            className="p-2.5 rounded-md hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-500 transition-colors duration-150"
